...
<!-- NO.1080 UNION · 自声明：本文件＝zylos-memory 记忆 SKILL 的并集，以演进版(新半 30ad5074)为基 ＋ 回收未吸收旧闸 ＋ 一条口径(step6/7 auto-trim)已裁严。非“合并”非“演进替代”——是双向超集。构建脚本＋验收 provenance 见 companion note no1080-union-candidate.NOTE.md(须与本件同行)。 -->
