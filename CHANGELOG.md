...
### Fixed
- Mark natural-language WorkIntake task conversations as delivered before
  Agent dispatch can re-enter them, preventing a single Feishu request from
  creating the same native task twice.
